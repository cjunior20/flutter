...
```dart
    ...
    20.verticalSpacing  // SizedBox(height: setHeight(20))
    20.verticalSpaceFromWidth // SizedBox(height: setWidth(20))
    20.verticalSpacingRadius //SizedBox(height: radius(20))

    20.horizontalSpaceRadius  // SizedBox(width: radius(20))
    20.horizontalSpace  // SizedBox(width: setWidth(20))
```
